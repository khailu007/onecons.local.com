...
function we_project_custom_post_type(){
    /*
     * Biến $label để chứa các text liên quan đến tên hiển thị của Post Type trong Admin
     */
    $label = array(
        'name' => 'Dự án', //Tên post type dạng số nhiều
    ...
    register_taxonomy('cateproject', 'project', array(
		'hierarchical' 			=> true,
		'label' 				=> 'Danh mục dự án',
		'singular_label' 		=> 'Danh mục dự án ',
		'rewrite'				=> true,
    ...
    register_taxonomy('local_project', 'project', array(
		'hierarchical' 			=> true,
		'label' 				=> 'Địa điểm',
		'singular_label' 		=>  'Địa điểm',
		'rewrite'				=> true,
		// 'rewrite' => array('slug' => 'projects', 'with_front' => true),
		// 'rewrite' => array('slug' => ''),
		'query_var' 			=> true,
...
add_action('init', 'we_project_custom_post_type');
...
/*	Styles & scripts
/*-----------------------------------------------------------------------------------*/
function pix_project_admin_styles() {
...
add_action('admin_print_styles', 'pix_project_admin_styles');

function pix_project_admin_scripts() {
...
add_action('admin_print_scripts', 'pix_project_admin_scripts');