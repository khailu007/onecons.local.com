						...
						if ( 'project' === get_post_type() ) :
							...
							if(!$post_intro){
								...
								if(!function_exists('essentials_core_plugin')){
									the_title( '<h1 class="pix-post-title pix-mt-20">', '</h1>', true );
									...
									the_title( '<h1 class="pix-post-title pix-mt-20 '.$title_sliding.' font-weight-bold" data-class="'.$text_class.'">', '</h1>', true );
								}
